...
<button onclick="window.location.href = 'https://protected-refuge-92528.herokuapp.com/projects/creativeHeartbeats/theme/index.php';">Creative Heartbeats</button>
<button onclick="window.location.href = '/projects/creativeHeartbeats/theme/index.php';">Creative Heartbeats (Local Host)</button>
